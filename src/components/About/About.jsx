...
export default function About() {
  ...
  return (
    <div className="py-40">
      ...
      <div className={styles.about}>
        <div className={styles.info}>
          <h1>👋I'm Saurav Satpute</h1>
          <p>
            I'm Computer Science graduate from india. I have strong problem
        ...
        <div className={styles.imgDiv}>
          <img
            style={styleImg}
            src="saurav-removebg.png"
            alt="Saurav Satpute"
          />
          <p>Software Engineer( MERN Stack ) at </p>
          <img
            src="https://www.angularminds.com/logos/angular-minds.svg"
            style={{ width: "150px" }}
            alt=""
          />
        </div>
